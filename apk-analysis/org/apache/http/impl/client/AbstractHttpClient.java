...
public abstract class AbstractHttpClient extends CloseableHttpClient {
    ...
    public final CloseableHttpResponse doExecute(HttpHost httpHost, HttpRequest httpRequest, HttpContext httpContext) {
        ...
        if (connectionBackoffStrategy2 == null || backoffManager2 == null) {
            return CloseableHttpResponseProxy.newProxy(createClientRequestDirector.execute(httpHost3, httpRequest2, defaultedHttpContext));
        }
        if (httpHost3 != null) {
            httpHost2 = httpHost3;
        } else {
            try {
                ...
                if (connectionBackoffStrategy2.shouldBackoff((Throwable) e10)) {
                    backoffManager2.backOff(determineRoute);
                }
                throw e10;
            } catch (Exception e11) {
                if (connectionBackoffStrategy2.shouldBackoff((Throwable) e11)) {
                    backoffManager2.backOff(determineRoute);
                }
                ...
                throw new ClientProtocolException((Throwable) e12);
            }
        }
        determineRoute = routePlanner2.determineRoute(httpHost2, httpRequest2, defaultedHttpContext);
        CloseableHttpResponse newProxy = CloseableHttpResponseProxy.newProxy(createClientRequestDirector.execute(httpHost3, httpRequest2, defaultedHttpContext));
